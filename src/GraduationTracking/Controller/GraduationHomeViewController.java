...
public class GraduationHomeViewController {
    ...
    public void updateProgressBar(){
        int max = view.getInProgressTable().getRowCount() + view.getCoursesCompletedTable().getRowCount();
        int val = view.getCoursesCompletedTable().getRowCount();
        view.getDegreeProgressBar().setMaximum(max);
        view.getDegreeProgressBar().setValue(val);
    }
