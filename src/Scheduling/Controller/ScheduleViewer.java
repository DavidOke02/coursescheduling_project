...
public class ScheduleViewer {
    ...
    public void createScheduleTable(){
        ...
        try {
            ...
            createUserTable.executeUpdate("CREATE TABLE IF NOT EXISTS Schedule (" +
                    ...
                    "  `waitlist_status` VARCHAR(45) NULL," +
    ...
    public void displayCourseList(){ //This is just a way to add optional filtering without making 2 almost the same funcs
        ...
        try{
            ...
            DefaultTableModel tableModel = (DefaultTableModel) view.getTable1().getModel();
            tableModel.setRowCount(0);
            tableModel.addColumn("Course ID");
            tableModel.addColumn("Registration Status");
            tableModel.addColumn("Waitlist Status");
